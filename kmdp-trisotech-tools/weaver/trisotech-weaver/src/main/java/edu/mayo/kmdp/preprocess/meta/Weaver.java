...
//	} CAO
  ...
  private String getSchemaLocations( Document dox ) {
    ...
    System.out.println("KnowledgeRepresentationLanguage.DMN_1_2.getRef(): " + KnowledgeRepresentationLanguage.DMN_1_2.getRef());
    ...
    if ( baseNS.contains( "DMN" ) ) {
      sb.append( " " )
              .append( KnowledgeRepresentationLanguage.DMN_1_2.getRef() )
              .append( " " ).append( Registry.getValidationSchema( KnowledgeRepresentationLanguage.DMN_1_2.getRef() )
              .orElseThrow( IllegalStateException::new ) );
